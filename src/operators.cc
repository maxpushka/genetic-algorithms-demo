...
TournamentWithReplacement::TournamentWithReplacement(pagmo::population::size_type t_size) 
...
TournamentWithoutReplacement::TournamentWithoutReplacement(pagmo::population::size_type t_size) 
  : tournament_size(t_size) {}
...
TournamentWithParticipation::TournamentWithParticipation(pagmo::population::size_type t_size) 
  : tournament_size(t_size) {}
