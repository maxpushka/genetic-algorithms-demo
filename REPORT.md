...
## Вступ: розробник, походження та філософія бібліотеки
...
3. **Використання мета-алгоритмів**:
   - Найкраще підходить алгоритм `mbh` (Monotonic Basin Hopping), який може
     ефективно досліджувати простір параметрів:
   ```cpp
